...
public class JavaModelRenderer implements Serializable
{
    ...
    public JavaModelRenderer(JavaModel model)
    {
        this(model, (String)null);
    }

    public JavaModelRenderer(JavaModel model, int texOffX, int texOffY)
    {
        this(model);
     ...
     */
    public void addChild(JavaModelRenderer renderer)
    {
        if (this.childModels == null)
        {
            this.childModels = Lists.<JavaModelRenderer>newArrayList();
        }

        this.childModels.add(renderer);
    }

    public JavaModelRenderer setTextureOffset(int x, int y)
    {
    ...
    public JavaModelRenderer addBox(String partName, float offX, float offY, float offZ, int width, int height, int depth)
    {
    ...
    public JavaModelRenderer addBox(float offX, float offY, float offZ, int width, int height, int depth)
    {
        this.cubeList.add(new ModelBox(this, this.textureOffsetX, this.textureOffsetY, offX, offY, offZ, width, height, depth, 0.0F));
        return this;
    }

    public JavaModelRenderer addBox(float offX, float offY, float offZ, int width, int height, int depth, boolean mirrored)
    {
            ...
            if (this.showModel)
            {
                ...
                if (this.rotateAngleX == 0.0F && this.rotateAngleY == 0.0F && this.rotateAngleZ == 0.0F)
                {
                    if (this.rotationPointX == 0.0F && this.rotationPointY == 0.0F && this.rotationPointZ == 0.0F)
                    {
                        ...
                        if (this.childModels != null)
                        {
                            ...
                            {
                                ((JavaModelRenderer)this.childModels.get(k)).render(scale);
                            }
                        }
                    }
                    else
                    {
                        ...
                        if (this.childModels != null)
                        {
                            ...
                            {
                                ((JavaModelRenderer)this.childModels.get(j)).render(scale);
                            }
                        }
                ...
                else
                {
                    ...
                    if (this.childModels != null)
                    {
                        ...
                        {
                            ((JavaModelRenderer)this.childModels.get(i)).render(scale);
                        }
                    }
     ...
     */
    public JavaModelRenderer setTextureSize(int textureWidthIn, int textureHeightIn)
    {
