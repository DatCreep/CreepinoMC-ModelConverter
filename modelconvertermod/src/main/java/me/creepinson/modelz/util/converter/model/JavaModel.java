...
public class JavaModel implements Serializable{
	...
	public JavaModel(int texHeight, int textWidth){
		super();
    ...
    public List<JavaModelRenderer> boxList = Lists.<JavaModelRenderer>newArrayList();
    ...
    {
    	for(JavaModelRenderer box : this.boxList){
    		box.render(scale);
    	}
    }
    ...
    public JavaModelRenderer getRandomModelBox(Random rand)
    {
